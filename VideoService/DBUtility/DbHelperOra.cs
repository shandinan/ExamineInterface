...
namespace VideoService.DBUtility
{
    /// <summary>
    ...
    public abstract class DbHelperOra
    {
        ...
        /// </summary>		
        //public static string connectionString = "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=10.66.174.10)(PORT=1521))" +
        //                            "(CONNECT_DATA=(SERVICE_NAME=dlmis)));User Id=xyjk;Password=xyjk;Connection Timeout=5;Pooling=true;Min Pool Size=1;Max Pool Size=255;";
        ...
        public static DataSet Query_1(string SQLString)
        {
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>影响的记录数</returns>
        public static int ExecuteSql_1(string SQLString, params OracleParameter[] cmdParms)
        {
            using (OracleConnection connection = new OracleConnection(connString))
            {
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet Query_1(string SQLString, params OracleParameter[] cmdParms)
        {
            using (OracleConnection connection = new OracleConnection(connString))
            {
                OracleCommand cmd = new OracleCommand();
